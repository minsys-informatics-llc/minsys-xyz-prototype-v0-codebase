...
export function TermsOfServicePage() {
  ...
  return (
    <LegalLayout title="Terms of Service" lastUpdated="April 9, 2026">
      ...
      <p className="text-white/75 mb-4 leading-relaxed">
        Minsys is a private operating group. Informations about our business & operating models, or other activities are presented for general awareness. Past performance of any M&A activity or venture(s) described does not guarantee future results.
      </p>
      ...
      <h2 className="text-solarAmber uppercase tracking-widest text-sm font-bold mt-10 mb-3">4. Intellectual Property</h2>
      <p className="text-white/75 mb-4 leading-relaxed">
        All content on this website — including but not limited to text, graphics, logos, images, the Minsys brand identity, the hybrid "Venture-Building Micro-PE" model, "Augmentation over Automation" Slogan, and the Four Pillars organizational framework — is the intellectual property of Minsys Holdings, LLC and is protected by applicable copyright, trademark, and intellectual property laws.
      </p>
      <p className="text-white/75 mb-4 leading-relaxed">
        Our Capabilities — including Minsys Software Factory, Minsys Competitive Intelligence, Minsys AI Factory, Minsys Cloud Migration Factory, Minsys Business Agility, Minsys Technology Benchmarking, Minsys Cybersecurity are core intellectual property that the Minsys Group leverages to conduct the "Unlocking Main Street's Hidden Value by Spinning-Off Digital & AI Ventures".
      </p>
      <p className="text-white/75 mb-4 leading-relaxed">
      ...
      <h2 className="text-solarAmber uppercase tracking-widest text-sm font-bold mt-10 mb-3">5. Accuracy of Information</h2>
      <p className="text-white/75 mb-4 leading-relaxed">
      ...
      <h2 className="text-solarAmber uppercase tracking-widest text-sm font-bold mt-10 mb-3">6. Third-Party Links</h2>
      <p className="text-white/75 mb-4 leading-relaxed">
      ...
      <h2 className="text-solarAmber uppercase tracking-widest text-sm font-bold mt-10 mb-3">7. Limitation of Liability</h2>
      <p className="text-white/75 mb-4 leading-relaxed">
      ...
      <h2 className="text-solarAmber uppercase tracking-widest text-sm font-bold mt-10 mb-3">8. Privacy</h2>
      <p className="text-white/75 mb-4 leading-relaxed">
      ...
      <h2 className="text-solarAmber uppercase tracking-widest text-sm font-bold mt-10 mb-3">9. Governing Law</h2>
      <p className="text-white/75 mb-4 leading-relaxed">
      ...
      <h2 className="text-solarAmber uppercase tracking-widest text-sm font-bold mt-10 mb-3">10. Changes to These Terms</h2>
      <p className="text-white/75 mb-4 leading-relaxed">
      ...
      <h2 className="text-solarAmber uppercase tracking-widest text-sm font-bold mt-10 mb-3">11. Contact</h2>
