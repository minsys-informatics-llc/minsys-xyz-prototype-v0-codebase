  ...
  return (
    <section ref={myRef} id="hero" className="relative flex items-center justify-center overflow-hidden min-h-[70vh] pt-12 pb-32">
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center w-full">
        ...
        <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl text-white font-black leading-tight mb-6">Your Vision, as a Venture</h1>
        <p className="text-[#F8F9FA] max-w-3xl mx-auto mb-0 leading-tight font-light text-xl md:text-2xl">
          <strong>We don't deliver projects.<br/>We engineer <span style={{ color: '#FD5E53', fontWeight: 'bold' }}>Your</span> next revenue stream as a <span style={{ color: '#FD5E53', fontWeight: 'bold' }}>Venture</span></strong>
        </p>
        <p className="text-[#F8F9FA] max-w-3xl mx-auto mt-6 mb-8 leading-tight font-light text-lg md:text-xl">
          Minsys is a Lean, AI-Powered, and Profitable (LAP) organization.<br/>We Bootstrap and Scale Next-Gen Digital &amp; AI Native Ventures.
        </p>
